...
class UserModelTest(TestCase):
    def test_user_creation_valid(self):
        """Vérifie qu'un utilisateur valide est correctement créé."""
    ...
    def test_user_creation_invalid_age(self):
        """Vérifie qu'un utilisateur de moins de 15 ans lève une ValidationError."""
        user = User(
            username="bob",
            password="pass123",
            age=10,
    ...
    def test_user_missing_booleans(self):
        """Vérifie qu'un utilisateur sans valeurs booléennes n'est pas valide."""
        user = User(
            username="charlie",
            password="pass123",
            age=20,
